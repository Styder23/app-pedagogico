            ...
            <main class="p-6 space-y-6">
                <div class="page-hero">
                    ...
                    <div>
                        ...
                        <h1 class="text-3xl font-bold">Gestión de notas</h1>
                        <p class="text-white/80 text-sm">Integra evaluaciones por exámenes, trabajos o tareas según grado y sección.</p>
                    </div>
                </div>
                <livewire:data-upload-manager tipo="notas" />
            </main>
        </div>
    </div>
</x-layouts.app>
